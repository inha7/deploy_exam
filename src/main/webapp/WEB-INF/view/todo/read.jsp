        ...
        <div class="card">
          ...
          <div class="card-body">
            <%--                        여기에작성--%>
              ...
              <script>
                document.querySelector(".btn-primary").addEventListener("click", function () { // 조회(현재)에서 수정
                    self.location=`/todo/modify?tno=${dto.tno}&${pageRequestDTO.link}`;
                }, false);
                document.querySelector(".btn-secondary").addEventListener("click", function () { // 조회(현재)에서 목록
